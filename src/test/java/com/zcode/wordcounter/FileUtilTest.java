...
import static com.zcode.wordcounter.logic.WordCounter.STOP_WORDS_FILE_PATH;
...
public class FileUtilTest {
    ...
    void readLines() throws IOException {
        List<String> stopWords = FileUtil.readLines(STOP_WORDS_FILE_PATH);
    ...
    void readLinesThrowsException() {
        ...
        assertEquals("No file was found for the provided path!", error.getMessage());
    }
